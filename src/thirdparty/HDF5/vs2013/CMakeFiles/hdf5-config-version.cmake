...
if("${PACKAGE_VERSION}" VERSION_LESS "${PACKAGE_FIND_VERSION}" )
  ...
  if ("${PACKAGE_FIND_VERSION_MAJOR}" STREQUAL "1")
    ...
    if ("${PACKAGE_FIND_VERSION_MINOR}" STREQUAL "8")
      ...
      if ("${PACKAGE_FIND_VERSION_PATCH}" STREQUAL "15")
        set (PACKAGE_VERSION_EXACT TRUE)
   
        if ("${PACKAGE_FIND_VERSION_TWEAK}" STREQUAL "patch1")
          # not using this yet
        endif ("${PACKAGE_FIND_VERSION_TWEAK}" STREQUAL "patch1")
      endif ("${PACKAGE_FIND_VERSION_PATCH}" STREQUAL "15")
