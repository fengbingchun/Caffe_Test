...
FORCE_REG(DummyData);
FORCE_REG(Eltwise);
FORCE_REG(EuclideanLoss);
FORCE_REG(Exp);
FORCE_REG(Filter);
FORCE_REG(Flatten);
FORCE_REG(HDF5Data);
FORCE_REG(HDF5Output);
FORCE_REG(HingeLoss);
FORCE_REG(Im2col);
FORCE_REG(ImageData);
FORCE_REG(InfogainLoss);
FORCE_REG(InnerProduct);
FORCE_REG(LRN);
FORCE_REG(Log);
FORCE_REG(MVN);
FORCE_REG(MemoryData);
FORCE_REG(MultinomialLogisticLoss);
FORCE_REG(PReLU);
FORCE_REG(Pooling);
FORCE_REG(Power);
FORCE_REG(ReLU);
...
FORCE_REG(SPP);
FORCE_REG(Sigmoid);
FORCE_REG(SigmoidCrossEntropyLoss);
FORCE_REG(Silence);
FORCE_REG(Slice);
FORCE_REG(Softmax);
