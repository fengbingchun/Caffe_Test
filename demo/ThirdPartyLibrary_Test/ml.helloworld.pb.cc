...
namespace protobuf_ml_2ehelloworld_2eproto {
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "ml.helloworld.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
helloworld::helloworld()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_ml_2ehelloworld_2eproto::InitDefaults();
  }
  SharedCtor();
...
const ::google::protobuf::Descriptor* helloworld::descriptor() {
  protobuf_ml_2ehelloworld_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_ml_2ehelloworld_2eproto::file_level_metadata[0].descriptor;
}
...
::google::protobuf::Metadata helloworld::GetMetadata() const {
  protobuf_ml_2ehelloworld_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_ml_2ehelloworld_2eproto::file_level_metadata[0];
}
