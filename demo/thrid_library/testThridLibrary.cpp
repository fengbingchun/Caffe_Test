...
std::string data_path = "E:/GitCode/Caffe_Test/test_data/thrid_library/";
...
#ifdef _DEBUG
	const char* exe = "E:/GitCode/Caffe_Test/lib/dbg\x86_vc12/testThridLibrary[dbg_x86_vc12].exe";
#else
	const char* exe = "E:/GitCode/Caffe_Test/lib/rel/x86_vc12/testThridLibrary[rel_x86_vc12].exe";
#endif
