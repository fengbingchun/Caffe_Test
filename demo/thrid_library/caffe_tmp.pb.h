...
class BlobShape : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_caffe_5ftmp_2eproto();
  friend void protobuf_AssignDesc_caffe_5ftmp_2eproto();
  friend void protobuf_ShutdownFile_caffe_5ftmp_2eproto();
